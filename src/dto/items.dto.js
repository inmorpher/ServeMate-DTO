...
exports.FoodItemSortOptions = Object.assign(Object.assign({}, exports.ItemSortOptions), { TYPE: 'type', CATEGORY: 'category', ALLERGIES: 'allergies', PREPARATION_TIME: 'preparationTime', SPICY_LEVEL: 'spicyLevel', CALORIES: 'calories', IS_VEGAN: 'isVegan', IS_GLUTEN_FREE: 'isGlutenFree' });
exports.DrinkItemSortOptions = Object.assign(Object.assign({}, exports.ItemSortOptions), { CATEGORY: 'category', VOLUME: 'volume', ALCOHOL_PERCENTAGE: 'alcoholPercentage', IS_CARBONATED: 'isCarbonated', TEMPRITURE: 'tempriture' });
//type: FoodType,
...
exports.searchFoodItemsSchema = exports.foodItemSchema.partial().extend(Object.assign(Object.assign({}, global_1.searchCriteriaSchema.shape), { sortBy: zod_1.z.nativeEnum(exports.FoodItemSortOptions).optional().default(exports.FoodItemSortOptions.ID) }));
exports.searchDrinkItemsSchema = exports.drinkItemSchema.partial().extend(Object.assign(Object.assign({}, global_1.searchCriteriaSchema.shape), { sortBy: zod_1.z.nativeEnum(exports.DrinkItemSortOptions).optional().default(exports.DrinkItemSortOptions.ID) }));
/**
