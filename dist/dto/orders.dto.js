...
const baseItemSchema = zod_1.z.object({
    ...
    allergies: zod_1.z.array(zod_1.z.enum(exports.Allergies)).default([]),
    printed: zod_1.z.boolean().default(false),
    fired: zod_1.z.boolean().default(false),
    guestNumber: zod_1.z.number().int().positive(),
    paymentStatus: zod_1.z.enum(exports.PaymentStatus).default(exports.PaymentStatus.NONE),
});
...
const orderItemRawSchema = zod_1.z.object({
    id: zod_1.z.number().int().positive(),
    price: zod_1.z.number().nonnegative(),
    discount: zod_1.z.number().default(0),
    itemId: zod_1.z.number().int().positive(),
...
exports.OrderSchema = zod_1.z.object({
    ...
    status: zod_1.z.enum(enums_1.OrderState).default(enums_1.OrderState.RECEIVED),
