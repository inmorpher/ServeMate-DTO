...
export declare const UserParamSchema: z.ZodObject<{
    ...
    role: z.ZodPreprocess<z.ZodOptional<z.ZodEnum<{
        readonly ADMIN: "ADMIN";
        readonly USER: "USER";
        readonly HOST: "HOST";
        readonly MANAGER: "MANAGER";
    ...
    createdAfter: z.ZodOptional<z.ZodPipe<z.ZodString, z.ZodTransform<Date | undefined, string>>>;
    createdBefore: z.ZodOptional<z.ZodPipe<z.ZodString, z.ZodTransform<Date | undefined, string>>>;
}, z.core.$strip>;
/**
